...
public class ItemRegistry {
    ...
    public static final FlyingApparatusItem mmu_signalum = new FlyingApparatusItem(12000, "apparatus_signalum", true, .5, 300);
    public static final FlyingApparatusItem mmu_resonant = new FlyingApparatusItem(20000, "apparatus_resonant", true, .6, 200);
